/*
 ...
 Source Server         : lingzhong_video
 Source Server Type    : MySQL
 Source Server Version : 80024 (8.0.24)
 Source Host           : 82.157.145.197:3306
...
CREATE TABLE `label`  (
  ...
  `user_id` int NOT NULL COMMENT '添加标签的用户id',
...
-- Records of label
-- ----------------------------
INSERT INTO `label` VALUES (1, '体育', -1);
